 ...
 * table carries no organization_id to scope by). Unqualified table name:
 * resource_db's tables live in the default `public` schema (§14.1), unlike
 * user-service's `users.` and subscription-service's `subs.` copies.
 */
@Injectable()
